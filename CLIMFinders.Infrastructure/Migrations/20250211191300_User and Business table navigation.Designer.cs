...
namespace CLIMFinders.Infrastructure.Migrations
{
    ...
    [Migration("20250211191300_User and Business table navigation")]
    partial class UserandBusinesstablenavigation
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Given.DataContext.Entities.SubscriptionPlans", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            AddedById = 0,
                            AddedOn = new DateTime(2025, 2, 12, 0, 43, 0, 350, DateTimeKind.Local).AddTicks(2645),
                            Amount = 0m,
                            Duration = 0,
                            IsDeleted = false,
                            ModifiedById = 0,
                            ModifiedOn = new DateTime(2025, 2, 12, 0, 43, 0, 350, DateTimeKind.Local).AddTicks(2660),
                            Tier = "Free Tier"
                        },
                        new
                        {
                            Id = 2,
                            AddedById = 0,
                            AddedOn = new DateTime(2025, 2, 12, 0, 43, 0, 350, DateTimeKind.Local).AddTicks(2663),
                            Amount = 10m,
                            Duration = 1,
                            IsDeleted = false,
                            ModifiedById = 0,
                            ModifiedOn = new DateTime(2025, 2, 12, 0, 43, 0, 350, DateTimeKind.Local).AddTicks(2663),
                            Tier = "Paid Tier"
                        });
                });
            ...
            modelBuilder.Entity("Given.DataContext.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            AddedById = 0,
                            AddedOn = new DateTime(2025, 2, 12, 0, 43, 0, 350, DateTimeKind.Local).AddTicks(7632),
                            ConfirmedOn = new DateTime(2025, 2, 12, 0, 43, 0, 350, DateTimeKind.Local).AddTicks(7641),
                            Email = "admin@admin.com",
                            FullName = "SuperAdmin",
                            IsConfirmed = true,
                            IsDeleted = false,
                            ModifiedById = 0,
                            ModifiedOn = new DateTime(2025, 2, 12, 0, 43, 0, 350, DateTimeKind.Local).AddTicks(7638),
                            Password = "MDAwMA==",
                            PasswordHash = new byte[] { 145, 71, 163, 111, 162, 218, 166, 20, 178, 116, 24, 145, 31, 225, 101, 108, 124, 128, 175, 166, 130, 170, 22, 178, 227, 110, 177, 251, 126, 222, 220, 93, 233, 212, 190, 255, 206, 117, 189, 17, 72, 62, 187, 83, 180, 163, 95, 27, 53, 147, 114, 142, 5, 179, 77, 50, 113, 93, 118, 187, 114, 71, 133, 229, 16, 105, 97, 90, 26, 29, 90, 252, 55, 79, 98, 168, 13, 93, 68, 93, 35, 130, 117, 26, 78, 155, 135, 117, 252, 57, 83, 64, 249, 101, 81, 52, 66, 2, 99, 242, 114, 104, 94, 223, 193, 252, 174, 217, 16, 122, 93, 202, 72, 180, 27, 216, 46, 113, 23, 212, 112, 149, 173, 83, 47, 162, 60, 109 },
                            PasswordSalt = new byte[] { 102, 66, 188, 109, 63, 203, 87, 58, 75, 100, 72, 140, 131, 113, 133, 103, 222, 245, 244, 34, 181, 239, 202, 201, 125, 253, 179, 208, 29, 72, 50, 117, 233, 138, 113, 11, 42, 46, 132, 84, 232, 57, 12, 112, 76, 213, 29, 85, 132, 236, 221, 196, 72, 205, 215, 201, 22, 235, 75, 36, 110, 151, 52, 123 },
                            RoleId = 1
                        });
                });
